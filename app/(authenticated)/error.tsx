    ...
    <div className="flex min-h-[calc(100vh-4rem)] items-center justify-center bg-slate-50 px-4">
      <div className="w-full max-w-md rounded-lg bg-white p-8 shadow-lg">
        <div className="mb-6 text-center">
          ...
          <h1 className="mb-2 text-2xl font-bold text-slate-900">Oops! Something went wrong</h1>
          <p className="text-slate-600">
            Don&apos;t worry, your data is safe. We&apos;ve been notified and are looking into it.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-3">
          ...
          <a
            href="/dashboard"
            className="w-full rounded-md border border-slate-300 px-4 py-3 text-center font-semibold text-slate-700 transition-colors hover:bg-slate-50 focus:outline-none focus:ring-2 focus:ring-slate-500 focus:ring-offset-2"
          >
            Back to Dashboard
          </a>
          <a
