...
const GRADE_OPTIONS = [
  ...
  { value: 1.5, label: '1.5 - Fa/G' },
  { value: 1.8, label: '1.8 - G-' },
  { value: 2.0, label: '2.0 - Good' },
  { value: 2.5, label: '2.5 - G+' },
  { value: 3.0, label: '3.0 - G/VG' },
  { value: 3.5, label: '3.5 - VG-' },
  { value: 4.0, label: '4.0 - Very Good' },
  { value: 4.5, label: '4.5 - VG+' },
  { value: 5.0, label: '5.0 - VG/FN' },
  { value: 5.5, label: '5.5 - FN-' },
  { value: 6.0, label: '6.0 - Fine' },
  { value: 6.5, label: '6.5 - FN+' },
  { value: 7.0, label: '7.0 - FN/VF' },
  { value: 7.5, label: '7.5 - VF-' },
  { value: 8.0, label: '8.0 - Very Fine' },
  { value: 8.5, label: '8.5 - VF+' },
  { value: 9.0, label: '9.0 - VF/NM' },
  { value: 9.2, label: '9.2 - NM-' },
  { value: 9.4, label: '9.4 - Near Mint' },
  { value: 9.6, label: '9.6 - NM+' },
  { value: 9.8, label: '9.8 - NM/M' },
