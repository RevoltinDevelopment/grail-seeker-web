  ...
  return (
    <div className={className}>
      ...
      <form onSubmit={handleLogin} className="space-y-4">
        <div>
          <label htmlFor="signin-email" className="mb-2 block text-sm font-medium text-slate-950">
            Email
          </label>
          <input
            id="signin-email"
        ...
        <div className="text-right">
          <Link href="/forgot-password" className="text-sm text-info-blue hover:underline">
            Forgot password?
          </Link>
        </div>
